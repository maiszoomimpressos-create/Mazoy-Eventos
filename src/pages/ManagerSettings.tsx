...
const ManagerSettings: React.FC = () => {
    ...
    const settingsOptions = [
        ...
        { icon: <Settings className="h-6 w-6 text-yellow-500" />, title: "Configurações Avançadas", description: "Ajustes de sistema, segurança e integrações.", path: "/manager/settings/advanced" }, // Rota atualizada
    ];
