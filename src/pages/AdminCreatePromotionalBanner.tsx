                            ...
                            <div className="space-y-4 pt-4 border-t border-yellow-500/20">
                                ...
                                {userId && (
                                    <ImageUploadPicker
                                        ...
                                        width={1200} // Largura recomendada para banners promocionais
                                        height={400} // Altura recomendada
                                        placeholderText="Clique para enviar ou arraste e solte uma imagem (1200px de largura por 400px de altura)"
